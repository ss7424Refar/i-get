{
  mode: 'production',
  context: '/home/refar/WebstormProjects/i-get',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    dgram: 'empty',
  ...
  output: {
    path: '/home/refar/WebstormProjects/i-get/itd-spa',
  ...
  resolve: {
    alias: {
      '@': '/home/refar/WebstormProjects/i-get/src',
    ...
    modules: [
      'node_modules',
      '/home/refar/WebstormProjects/i-get/node_modules',
      '/home/refar/WebstormProjects/i-get/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/home/refar/WebstormProjects/i-get/node_modules/.cache/vue-loader',
              cacheIdentifier: 'b8e098ae'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/home/refar/WebstormProjects/i-get/node_modules/mini-css-extract-plugin/dist/loader.js',
                options: {
                  hmr: false,
                  publicPath: '../'
                }
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          NODE_ENV: '"production"',
          VUE_APP_BASE_API: '"http://172.30.52.43/ats"',
          BASE_URL: '"/itd-spa/"'
        }
      }
    ),
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: '/home/refar/WebstormProjects/i-get/public/index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/home/refar/WebstormProjects/i-get/public',
          to: '/home/refar/WebstormProjects/i-get/itd-spa',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
